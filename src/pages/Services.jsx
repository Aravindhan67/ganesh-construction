            ...
            {services.map((service, index) => (
              <ScrollReveal key={service.id} animation="slide-up">
                <div className="grid-12" style={{ 
                  ...
                  {/* Text Content */}
                  <div className="col" style={{ '--col-desktop': 5, gridColumnStart: index % 2 === 0 ? 'auto' : 8, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                    <div style={{ 
                  ...
                  {/* Image Content */}
                  <div className="col" style={{ '--col-desktop': 6, gridColumnStart: index % 2 === 0 ? 7 : 1, gridRow: 1 }}>
